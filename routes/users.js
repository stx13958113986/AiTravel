...
router.post("/check", (req, res) => {
  ...
  router.get("/search",(req,res)=>{
    ...
    var sql = " select uname,user_name,phone,address from user where uid=?";
...
router.post("/update",(req,res)=>{
  var uid=req.body.uid;//新闻编号
  var user_name=req.body.user_name;
  var phone=req.body.phone;
  var address=req.body.address;
  console.log(req.body);
  console.log(address);
  var sql = " UPDATE user SET user_name = ?,phone=?,address=? WHERE uid = ?";
  pool.query(sql,[user_name,phone,address,uid],(err,result)=>{
      if(err)
      throw err;
      console.log()
